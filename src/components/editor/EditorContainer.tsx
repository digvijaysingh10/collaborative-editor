...
export default function EditorContainer() {
  const { editorRef, status, users, handleManualSave, saveAsWord, saveAsPDF } = useEditor();
      ...
      <div className="w-full max-w-5xl bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl">
        <div className="flex justify-between items-center p-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white">
          ...
          <div className="flex space-x-2">
            ...
            <button
              onClick={saveAsWord}
              className="px-4 py-2 text-sm font-medium bg-white text-blue-600 rounded-lg hover:bg-blue-100 transition-colors duration-200"
            >
              Save as Word
            </button>
            <button
